...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'AFgzipRequestSerializer.framework'
  install_framework 'Boilerplate.framework'
  install_framework 'Godzippa.framework'
  install_framework 'KSCrash.framework'
  install_framework 'MBProgressHUD.framework'
  install_framework 'MagicalRecord.framework'
  install_framework 'RaptureXML.framework'
  install_framework 'Reachability.framework'
  install_framework 'SSZipArchive.framework'
fi
